...
void FixRigidBigOMP::initial_integrate(int vflag)
{
  int ibody;
...
void FixRigidBigOMP::compute_forces_and_torques()
{
...
void FixRigidBigOMP::final_integrate()
{
  int ibody;
...
void FixRigidBigOMP::set_xv_thr()
{
