...
FixStyle(rigid/big/omp,FixRigidBigOMP)

#else

#ifndef LMP_FIX_RIGID_BIG_OMP_H
#define LMP_FIX_RIGID_BIG_OMP_H

#include "fix_rigid_big.h"

namespace LAMMPS_NS {

class FixRigidBigOMP : public FixRigidBig {
 public:
  FixRigidBigOMP(class LAMMPS *lmp, int narg, char **args)
    : FixRigidBig(lmp,narg,args) {};
  virtual ~FixRigidBigOMP() {};
